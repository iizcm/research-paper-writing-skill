...
| Field | Value |
| --- | --- |
| **Name** | `research-paper-writing-skill` |
...
cp -r research/research-paper-writing ~/.hermes/skills/research/research-paper-writing/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/research-paper-writing-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/research-paper-writing-skill.git ~/.hermes/skills/research/research-paper-writing/
```
...
```text
skill_view(name="research/research-paper-writing")
```
...
```text
Use the research paper writing skill to <describe your specific task here>
```
...
```text
Gunakan skill research paper writing untuk <deskripsikan tugas spesifik Anda di sini>
```
